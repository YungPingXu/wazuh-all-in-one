...
class CowrieSSHFactory(factory.SSHFactory):
    ...
    def __init__(self, backend, pool_handler, wi: WazuhInterface, rg: ResponseGenerator):
    ...
    def startFactory(self):
        ...
        # PPS: Initialize wazuh agents.
        self.wi.init_target_connection()
        self.wi.init_all_vm()
    ...
    def stopFactory(self):
        ...
        # PPS: Shutdown wazuh agents.
        if self.wi.vm_info['destroy_before_stop']:
            self.wi.shutdown_all_vm(True)
