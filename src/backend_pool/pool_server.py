...
class PoolServerFactory(Factory):
    ...
    def __init__(self, rg: response_generator.ResponseGenerator) -> None:
    ...
    def startFactory(self) -> None:
        ...
        if self.pool_service:
            ...
            # PPS: Provide backend pool info to response generator.
            self.rg.backendPool = self.pool_service.guests
    ...
    def stopFactory(self) -> None:
        ...
        if self.pool_service:
            ...
            # PPS: Remove backend pool info to response generator.
            self.rg.backendPool = []
